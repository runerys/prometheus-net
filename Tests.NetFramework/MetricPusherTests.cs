    ...
    public sealed class MetricPusherTests
    {
        ...
        private void RunHttpClientExceptionScenario(Exception throwOnHttpPost){
            ...
            var pusher = new MetricPusher(new MetricPusherOptions
            {
                ...
                OnError = OnError,
                HttpClientProvider = () => new ExceptionThrowingHttpClient(throwOnHttpPost)
            });
        ...
        private class ExceptionThrowingHttpClient : HttpClient{
            private Exception _throwOnSend;
            public ExceptionThrowingHttpClient(Exception ex)
            {
                _throwOnSend = ex;
            }
